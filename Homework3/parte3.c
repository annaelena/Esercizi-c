...
/*
 * Camping - Parte 3
Prendendo come arco temporale valido di apertura del camping dal 1/06/XXXX al
31/09/XXXX gestire le prenotazioni del camping fornendo a video un feedback se la data in
cui vogliono soggiornare i clienti può essere accettata in base alla disponibilità delle casette.
Predisporre una stampa che mostri le caratteristiche delle casette e la loro disponibilità,
mostrando per ogni casetta:
- nome e cognome dell’attuale affittuario
- disponibilità temporale
- percentuale di occupazione nel periodo di apertura
 */
